...
const OPERATOR_ROOT = "/root/operator";
  ...
  api.registerCommand({
    ...
    handler: async (ctx: any) => {
      ...
      try {
        ...
        return { text: `Research-Start fehlgeschlagen: ${e.message}` };
      }
    },
  });
  ...
  api.registerCommand({
    ...
    handler: async (ctx: any) => {
      ...
      try {
        ...
        return { text: `Research-Cycle fehlgeschlagen: ${e.message}` };
      }
    },
  });
  ...
  api.registerCommand({
    ...
    handler: async (ctx: any) => {
      ...
      try {
        ...
        return { text: `Research-Go fehlgeschlagen: ${e.message}` };
      }
    },
  });
  ...
  api.registerCommand({
    ...
    handler: async (ctx: any) => {
      ...
      try {
        ...
        return { text: `Status fehlgeschlagen: ${e.message}` };
      }
    },
  });
}
